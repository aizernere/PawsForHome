...
urlpatterns = [
    ...
    path('adoptionrequest/<int:request_id>/', views.adoption_request_detail, name='adoption_request_detail'), #shelter's adoption request view for a specific request
    path('adoptionrequest/all/<int:request_id>/', views.adoption_request_detail_all, name='adoption_request_detail_all'), #shelter's adoption request view for all
